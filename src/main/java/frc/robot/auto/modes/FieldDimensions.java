...
public class FieldDimensions 
{
    ...
    // Ball Positions
    public static final Vector2d redBall2of2  = new Vector2d(116, -26.5);   // near hangar
    public static final Vector2d blueBall2of2  = new Vector2d(116, -29.5);   // near hangar
    public static Vector2d[] ball2of2  = new Vector2d[]{redBall2of2, blueBall2of2};
    public static final Vector2d redTheirBall = new Vector2d(96, -83);    // left wall
    public static final Vector2d blueTheirBall = new Vector2d(95, -86);    // left wall
    ...
    // Ball Positions
    public static final Vector2d redBall2of3   = new Vector2d(117, 29);   // right wall
    public static final Vector2d blueBall2of3   = new Vector2d(116, 32);   // right wall
